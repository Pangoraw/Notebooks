...
# ╔═╡ 8a2efca6-3593-11ed-0b20-6d120bddcf5e
...
# ╔═╡ 1a409fec-9775-407a-a3bf-ba5c2e83adaa
X = let
	Σ = [
		1.5 σ # 0.
		σ 1.5 # 0.
	...
	D = MultivariateNormal([0., 0.,], Σ)
	rand(D, N)
end

# ╔═╡ afef8ea3-7abc-4983-9445-8caf7d38a7e4
X̂ = X .- mean(eachcol(X))

# ╔═╡ 0cb57e26-bb65-4a40-a51b-a242729a8511
Σ̂ = X̂ * X̂' ./ N

# ╔═╡ 77d740ca-620a-4aac-8209-d4cd9fc1b889
U, Σ, _ = svd(X̂)

# ╔═╡ fe090714-fb88-4ac9-a585-a9bfba6ad29d
T = U * Diagonal(Σ)

# ╔═╡ 8b30a46c-5d12-4cf5-bcd2-5e9a9dcae2b7
let
	scatter(eachrow(X)...; legend = :bottomright)
	quiver!(
		[0,0], [0,0],
		quiver = (
			T[1,:] ./ 2,
...
# ╔═╡ 2aec261b-6512-4478-829a-8dd281475a7b
md"""
The base is orthogonal:
"""

# ╔═╡ 6ef238e5-80ea-4960-b784-1987b0d9524c
var"T[:,1] ⋅ T[:,2]" = T[:,1] ⋅ T[:,2]
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "c734296c19ad123baef4b424263d8d5bda2b0682"
