...
# ╔═╡ 2efc5ee4-3453-11ed-128c-0d76119f220f
using ZMQ, PlutoHooks

# ╔═╡ 1f0ff621-8e06-46c6-9de4-48595bd0804c
md"""
---
"""

# ╔═╡ bedaa1a1-f71c-4ec9-9f09-842b6b45531d
"""
	@use_socket(address)

Example usage:
```julia
msg = @use_socket("tcp://*:5556")
```
"""
...
# ╔═╡ 862a8efd-bfe0-4461-aa73-ff5ccc78fda7
all_messages = let
	messages = @use_memo(() -> [], [])
	msg = @use_socket("tcp://*:5556")
	if !isnothing(msg)
...
# ╔═╡ e7ebf527-d42c-4156-8444-e4bed16ec9e3
all_messages

# ╔═╡ 5f353678-64b3-441c-80e1-80d1d2ee7708
#=
begin
   s = Socket(REQ)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "e23f607daf420004ddbac0f4915f593409f983ea"
