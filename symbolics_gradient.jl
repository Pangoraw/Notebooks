...
# ╔═╡ b14e3e44-6693-11ed-1536-d1ad4b7a28fb
using Symbolics

# ╔═╡ 7632c395-beab-4d6d-bf2d-d34eaecfc1c1
N = 3

# ╔═╡ 3ba5a48d-6e12-4905-8e4a-fae8eba21191
@variables X[1:N,1:N];

# ╔═╡ 8a05420f-092f-4fcc-a8ec-54babdcdae72
"""
Sums the trace of \$X\$.
"""
f(X) = sum(X[i,i] for i in 1:size(X,1))
...
# ╔═╡ e8f5514c-888b-4a60-b82a-e2b9535606df
gradient(f, X)
...
julia_version = "1.8.0"
manifest_format = "2.0"
project_hash = "6050e460393a2e92bba63d0d3d27120535b40880"
