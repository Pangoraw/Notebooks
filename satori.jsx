...
const statefileBuf = await Deno.readFile("/home/pberg/Downloads/OperationalTransform.plutostate")
    ...
    >
      <div
        style={{
          ...
          width: "25px",
          backgroundImage:
            "url(https://avatars.githubusercontent.com/u/9824244?v=4)",
...
const svg = await satori(
  <HeaderComponent
    ...
    summary="Textbook implementation of Optimal Transport from the book Computational Optimal Transport."
    imageUrl="https://user-images.githubusercontent.com/6933510/174067690-50c8128d-748b-4f50-8a76-2ce18166642b.png"
  />,
  {
    width: 600,
    height: 400,
...
const htmlContent = await Deno.readTextFile("OperationalTransform.html")
...
// await Deno.writeFile("OperationalTransform-og-image.png", pngBuffer);
